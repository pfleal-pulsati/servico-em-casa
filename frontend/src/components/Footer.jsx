      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <span className="text-base-content/70">Manutenção</span>
              </li>
              <li>
                <span className="text-base-content/70">Jardinagem</span>
              </li>
              <li>
                <span className="text-base-content/70">Tecnologia</span>
              </li>
              <li>
                <span className="text-base-content/70">Educação</span>
              </li>
              <li>
                <span className="text-base-content/70">Saúde e Bem-estar</span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-2 text-base-content/70">
                ...
                <span>contato@servicoemcasa.com</span>
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-base-content/60">
            © {currentYear} Serviço em Casa. Todos os direitos reservados.
          </div>
